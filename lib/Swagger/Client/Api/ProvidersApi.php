...
class ProvidersApi
{
    ...
    /**
     * Operation getProviders_0
     *
     * Find Providers
     *
     * @param \Swagger\Client\Model\RequestProvidersSearch $body  (required)
     * @return \Swagger\Client\Model\ProvidersGeocodeResponse
     * @throws \Vericred\Client\ApiException on non-2xx response
     */
    public function getProviders_0($body)
    {
        list($response) = $this->getProviders_0WithHttpInfo($body);
        return $response;
    }

    /**
     * Operation getProviders_0WithHttpInfo
     *
     * Find Providers
     *
     * @param \Swagger\Client\Model\RequestProvidersSearch $body  (required)
     * @return array of \Swagger\Client\Model\ProvidersGeocodeResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Vericred\Client\ApiException on non-2xx response
     */
    public function getProviders_0WithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling getProviders_0');
        }
        // parse inputs
        $resourcePath = "/providers/search/geocode";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProvidersGeocodeResponse',
                '/providers/search/geocode'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProvidersGeocodeResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProvidersGeocodeResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
