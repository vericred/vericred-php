...
/**
 * MedicalPlansApi Class Doc Comment
 *
 * @category Class
 * @package  Vericred\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class MedicalPlansApi
{
    ...
    public function findPlansWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/plans/medical/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
