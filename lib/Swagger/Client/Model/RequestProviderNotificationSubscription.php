<?php
/**
 * RequestProviderNotificationSubscription
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * RequestProviderNotificationSubscription Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Vericred\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RequestProviderNotificationSubscription implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'RequestProviderNotificationSubscription';
    ...
    /**
     * Sets npis
     * @param string[] $npis National Provider Index (NPI) numbers for providers.
     * @return $this
     */
    ...
    /**
     * Sets plan_id
     * @param string $plan_id The plan ID to watch for provider events.
     * @return $this
     */
    ...
    /**
     * Sets callback_url
     * @param string $callback_url The URL where notifications should be sent.
     * @return $this
     */
