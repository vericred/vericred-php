...
/**
 * ProviderShowResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Vericred\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProviderShowResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ProviderShowResponse';
    ...
    protected static $swaggerTypes = array(
        'provider' => '\Swagger\Client\Model\Provider'
    );
    ...
    /**
     * Sets provider
     * @param \Swagger\Client\Model\Provider $provider The requested provider.
     * @return $this
     */
