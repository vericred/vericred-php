...
/**
 * PlanMedicare Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Vericred\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PlanMedicare implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'PlanMedicare';
    ...
    /**
     * Sets id
     * @param string $id Government-issued MedicareAdvantage plan ID
     * @return $this
     */
