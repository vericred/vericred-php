...
/**
 * NetworkComparisonRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Vericred\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class NetworkComparisonRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'NetworkComparisonRequest';
    ...
    /**
     * Sets network_ids
     * @param int[] $network_ids List of Networks with which to compare the base Network
     * @return $this
     */
    ...
    /**
     * Sets radius
     * @param int $radius Radius from the provided Zip Code within which to search
     * @return $this
     */
    ...
    /**
     * Sets zip_code
     * @param string $zip_code Zip Code to use as a search origin
     * @return $this
     */
