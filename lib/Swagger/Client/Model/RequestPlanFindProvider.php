...
use \ArrayAccess;
/**
 * RequestPlanFindProvider Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Vericred\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RequestPlanFindProvider implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    static $swaggerModelName = 'RequestPlanFindProvider';
    ...
    /**
      * $npi NPI of provider to search for
      * @var int
      */
    protected $npi;
    ...
    /**
     * Sets npi
     * @param int $npi NPI of provider to search for
     * @return $this
     */
