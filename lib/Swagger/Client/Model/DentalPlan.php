 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DentalPlan implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'DentalPlan';
    ...
    /**
     * Sets id
     * @param string $id The dental plan identifier
     * @return $this
     */
    ...
    /**
     * Sets issuer_name
     * @param string $issuer_name Name of the insurance carrier
     * @return $this
     */
    ...
    /**
     * Sets plan_type
     * @param string $plan_type Category of the plan (e.g. EPO, HMO, PPO, POS, Indemnity, PACE,HMO w/POS, Cost, FFS, MSA)
     * @return $this
     */
