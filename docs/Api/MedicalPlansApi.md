# Vericred\Client\MedicalPlansApi
...
$api_instance = new Vericred\Client\Api\MedicalPlansApi();
...
try {
    ...
    echo 'Exception when calling MedicalPlansApi->findPlans: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling MedicalPlansApi->showPlan: ', $e->getMessage(), PHP_EOL;
}
?>
```
